                        ...
                        <div className="flex flex-wrap gap-3">
                            {contactLinks.map((link) => (
                                <Link
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-700/50 text-slate-300 transition-all hover:border-blue-400 hover:bg-blue-500/10 hover:text-blue-400"
                        ...
                        <nav className="flex flex-col gap-2">
                            {navigationLinks.map((link) => (
                                <Link
                                    key={link.label}
                                    href={link.href}
                                    className="group inline-flex w-fit items-center text-slate-300 transition-colors hover:text-blue-400"
                                >
